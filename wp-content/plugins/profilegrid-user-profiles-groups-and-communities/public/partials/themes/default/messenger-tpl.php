...
<div class="pmagic"> 
    ...
    <path d="M0-.5h24v24H0z" fill="none"/>
            ...
            <form id="chat_message_form" onsubmit="pm_messenger_send_chat_message(event);">  
                <input type="text" id="receipent_field"  value="" placeholder="<?php _e("send to..","profilegrid-user-profiles-groups-and-communities");?>" style="min-width: 550px;"/>
                ...
                <div class="pm-section-right-panel pm-section-content pm-difl pm_full_width_profile"  style="max-width: 550px;float:right;">
                    ...
                    <textarea id="messenger_textarea" name="content" style="width:80%;height:100px;"
                              data-emoji-input="unicode" data-emojiable="true"
                               form="chat_message_form" placeholder="<?php _e('Enter text here..','profilegrid-user-profiles-groups-and-communities');?>" onkeypress=""></textarea> 
                    <input type="hidden" name="sid" value="" />      
                    <input type="submit" name="send" value="<?php _e("send","profilegrid-user-profiles-groups-and-communities");?>" />
                </div>
            </form>
