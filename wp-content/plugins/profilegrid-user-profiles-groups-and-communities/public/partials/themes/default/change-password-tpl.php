...
<form class="pmagic-form pm-dbfl" name="resetpassform" id="resetpassform" method="post" autocomplete="off" onsubmit="return pm_frontend_change_password(this)">
     <div class="pmrow">        
        <div class="pm-col">
            ...
            <div class="pm-field-lable">
                <label for="pass1"><?php _e('New password','profilegrid-user-profiles-groups-and-communities');?><sup class="pm_estric">*</sup></label>
            </div>
     ...
     <div class="pmrow">        
        <div class="pm-col">
            <div class="pm-form-field-icon"></div>
            <div class="pm-field-lable">
                <label for="pass2"><?php _e('Repeat new password','profilegrid-user-profiles-groups-and-communities');?><sup class="pm_estric">*</sup></label>
            </div>
            <div class="pm-field-input pm_required">
