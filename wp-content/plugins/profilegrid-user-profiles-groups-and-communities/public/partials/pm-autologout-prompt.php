      ...
      <div class="pm-popup-image pm-dbfl pm-bg pm-pad10"> 
        ...
        <div class="pm-popup-action">
            <div class="pm-modal-footer">
                <button type="button" id="pg_btn_auto_logout" class="btn btn-default" onclick="pg_auto_logout_redirect()"><?php _e('Logout','profilegrid-user-profiles-groups-and-communities');?></button>
                <button type="button" id="pg_btn_auto_logout_continue" class="btn btn-primary" onclick="pg_auto_logout_prompt_close()"><?php _e('Continue','profilegrid-user-profiles-groups-and-communities');?></button>
            </div>
        </div>
