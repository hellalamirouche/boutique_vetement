...
<div class="uimagic">
    ...
    <div class="content">
      <div class="uimheader">
        <?php _e( 'Import Users','profilegrid-user-profiles-groups-and-communities' ); ?>
      </div>
     ...
     <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Upload CSV File','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        ...
        <div class="uimnote"><?php _e('Step 1: Alrighty then, let\'s get rolling! First step is simple. Select the CSV file containing users you wish to import to ProfileGrid.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
        <div id="import_hidden_form">
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Update Existing Users','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        ...
        <div class="uimnote"><?php _e('Step 3: Select the column separator in your sheet. If you are not sure, keep it as comma (,) the most common CSV separator.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
        
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Group','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput pm_select_required">
            <select name="import_pm_group" id="import_pm_group">
            <option value=""><?php _e('Select Group','profilegrid-user-profiles-groups-and-communities');?></option>
            <?php
        ...
        <div class="uimnote"><?php _e('Step 4: The Group in which you want to import the users from CSV.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      ...
      <div class="buttonarea"> <a href="admin.php?page=pm_tools">    
        ...
        <?php wp_nonce_field('pm_export_users'); ?>
          <input form="pm_import_users2" type="submit" value="<?php _e('Import','profilegrid-user-profiles-groups-and-communities');?>" name="import_users" id="import_users" />
