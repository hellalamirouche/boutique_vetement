...
<div class="uimagic">
  <form name="pm_message_settings" id="pm_message_settings" method="post">
    ...
    <div class="content">
      <div class="uimheader">
        <?php _e( 'Messaging Settings','profilegrid-user-profiles-groups-and-communities' ); ?>
      </div>
      ...
      <div class="uimsubheader">
        ...
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Enable Private Messaging','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e("Turn on private messaging system for your site users. Registered users can start conversations with each other.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      <div class="childfieldsrow" id="pm_enable_private_messaging_html" style=" <?php if($dbhandler->get_global_option_value('pm_enable_private_messaging',1)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
            <div class="uimrow">
                <div class="uimfield">
                  <?php _e( 'Enable Unread Message Notification','profilegrid-user-profiles-groups-and-communities' ); ?>
                </div>
                <div class="uiminput">
                ...
                <div class="uimnote"><?php _e("User will be notified when there's a new unread private message.",'profilegrid-user-profiles-groups-and-communities');?></div>
            </div>
          ...
          <div class="childfieldsrow" id="pm_unread_message_notification_html" style=" <?php if($dbhandler->get_global_option_value('pm_unread_message_notification',0)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
                ...
                <div class="uimrow">
                    ...
                    <div class="uiminput">
                     <input type="text" name="pm_unread_message_email_subject" id="pm_unread_message_email_subject" value="<?php echo $dbhandler->get_global_option_value('pm_unread_message_email_subject',__('New Private Message from {{sender_name}}','profilegrid-user-profiles-groups-and-communities'));?>" />
