...
<div class="pm-popup">
    <div class="pm-popup-header">
        ...
        <div class="pm-popup-field-box" onClick="add_pm_field('youtube', '<?php echo $gid; ?>')">
            ...
            <div class="pm-popup-field-details"><?php _e("A speciality URL field for asking YouTube Channel or Video page.",'profilegrid-user-profiles-groups-and-communities'); ?></div>
        </div>
    ...
    <?php endforeach;
            ...
            <div class="pm-custom-fields-page">
                    <?php if (isset($sections)): foreach ($sections as $section): ?>
                        <div id="<?php echo sanitize_key($section->section_name); ?>" class="field-selector-pills">
                            ...
                            <div class="pmrow"> <a href="admin.php?page=pm_add_section&id=<?php echo $section->id; ?>#<?php echo sanitize_key($section->section_name); ?>"><i class="fa fa-pencil" aria-hidden="true"></i><?php _e('Edit Section','profilegrid-user-profiles-groups-and-communities');?></a> <a href="admin.php?page=pm_add_section&action=delete&id=<?php echo $section->id; ?>&gid=<?php echo $gid; ?>"><i class="fa fa-trash" aria-hidden="true"></i><?php _e('Delete Section','profilegrid-user-profiles-groups-and-communities');?></a> </div>
            ...
            ?>
                                    <li>
                                        <div class="pm-slab"><?php _e("You haven't created any Profile Fields for this Section yet.",'profilegrid-user-profiles-groups-and-communities'); ?></div>
                                    </li>
                        <?php
                        endif;
                        ?>
...
<?php _e('Section Name','profilegrid-user-profiles-groups-and-communities'); ?>
                                    ...
                                    <div class="uimnote"><?php _e("Name of your Group.",'profilegrid-user-profiles-groups-and-communities'); ?></div>
                                </div>
                                <div class="uimrow">
...
<?php wp_nonce_field('save_pm_add_section'); ?>
    ...
    <?php if ($pmrequests->pm_check_field_exist($gid, 'user_pass', true) == false): ?>
        <div class="pm-notice">
            <div class="pm-notice-text"><?php _e('There’s no password field in your sign up form. You can auto-generated and email password to registering users. To do that please add password field to Account Activation email template associated with this Group.','profilegrid-user-profiles-groups-and-communities'); ?></div>
        </div>
<?php endif; ?>
