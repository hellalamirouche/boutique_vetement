  ...
  <form name="pm_security_settings" id="pm_security_settings" method="post">
    ...
    <div class="content">
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('The site administrator will be notified for each individual registration.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
