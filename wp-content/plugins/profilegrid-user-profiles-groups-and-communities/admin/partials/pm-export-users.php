  ...
  <form name="pm_export_users" id="pm_export_users" method="post">
    ...
    <div class="content">
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Step 1: Select the Group(s) from which you wish to export users. Press ctrl on Windows/Linux PC and ⌘ on Mac while selecting to choose multiple Groups.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
