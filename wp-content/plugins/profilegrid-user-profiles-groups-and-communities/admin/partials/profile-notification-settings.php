...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_profile_nofication_settings' ) ) die( __('Failed security check','profilegrid-user-profiles-groups-and-communities') );
...
<div class="uimagic">
  <form name="pm_profile_notification_settings" id="pm_profile_notification_settings" method="post">
    ...
    <div class="content">
      <div class="uimheader">
        <?php _e( 'Profile Notifications Settings','profilegrid-user-profiles-groups-and-communities' ); ?>
      </div>
      ...
      <div class="uimsubheader">
        ...
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Enable Live Profile Notifications','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e("This option allows you to control whether the notifications on user profiles will update live. If disabled, the notifications will update after each page refresh.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
