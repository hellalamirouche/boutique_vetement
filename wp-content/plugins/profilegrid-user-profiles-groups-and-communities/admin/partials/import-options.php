...
<div class="uimagic">
    ...
    <div class="content">
      <div class="uimheader">
        <?php _e( 'Import Options','profilegrid-user-profiles-groups-and-communities' ); ?>
      </div>
     ...
     <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Upload Json File','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
      ...
      <div class="buttonarea"> <a href="admin.php?page=pm_tools">    
        ...
        <?php wp_nonce_field('pm_import_options'); ?>
          <input type="submit" value="<?php _e('Import','profilegrid-user-profiles-groups-and-communities');?>" name="import_options" id="import_options" onclick="return pm_upload_jsonfile()" />
 ...
 <div class="pg-import-notification uimagic">
     <p style="color:red;"><?php _e('WARNING! This will overwrite all existing Global Settings option values, please proceed with caution!','profilegrid-user-profiles-groups-and-communities');?></p>
</div>