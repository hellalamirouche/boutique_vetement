...
<div class="uimrow">
    <div class="uimfield">
      <?php _e( 'Select Field(s):','profilegrid-user-profiles-groups-and-communities' ); ?>
    </div>
    ...
    <div class="uimnote"><?php _e('Step 2: Now select the fields you wish to export for each user in above selected Group(s). If you want to export everything, click on a field and press Ctrl+A or ⌘+A to select all of them.','profilegrid-user-profiles-groups-and-communities');?></div>
</div>