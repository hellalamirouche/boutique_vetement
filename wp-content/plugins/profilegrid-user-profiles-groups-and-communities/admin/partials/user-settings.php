  ...
  <form name="pm_user_settings" id="pm_user_settings" method="post">
    ...
    <div class="content">
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e("Automatically activate user accounts after registration form is submitted. Keep this setting off if you want to manually approve each registering user.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
