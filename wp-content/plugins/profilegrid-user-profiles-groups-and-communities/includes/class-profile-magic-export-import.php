...
class PM_Export_Import{
  ...
  public function pm_generate_mapping_table($post)
  {
        ...
        <div class="uimrow">
            <div class="uimfield">
                  <?php _e( 'Section','profilegrid-user-profiles-groups-and-communities' ); ?>
                </div>
                ...
                <div class="uimnote"><?php _e('Step 5: Select a section inside this Group where all imported fields will go. You can later redistribute the fields among different sections in Fields Manager.','profilegrid-user-profiles-groups-and-communities');?></div> 
        </div>

        <div class="uimrow">
            <div class="uimfield">
                  <?php _e( 'User Name','profilegrid-user-profiles-groups-and-communities' ); ?>
                </div>
                <div class="uiminput pm_select_required">
                ...
                <div class="uimnote"><?php _e('Step 6a: Map a column in your CSV to username field of this Group. New users will be assigned these usernames.','profilegrid-user-profiles-groups-and-communities');?></div> 
        </div>
        ...
        <div class="uimrow">
            <div class="uimfield">
                ...
                <div class="uimnote"><?php _e('Step 6b: Map a column in your CSV to User email field of this Group. Make sure the column contain email IDs.','profilegrid-user-profiles-groups-and-communities');?></div> 
        </div>
        ...
        <div class="pmagic-table">
                <table class="pg-import-table">
                    <tr class="pm_import_row">
                        <th><?php _e('CSV Mapping Scheme','profilegrid-user-profiles-groups-and-communities');?></th>
                        <th></th>
                        <th></th>
                        <th></th>
                    </tr>
        ...
        foreach($headings as $heading)
        {
            ?>
                ...
                <td><input type="radio" name="pm_map_field_<?php echo $i;?>" value="0" onclick="pm_map_field_show_hide(0,'#pm_map_field_with_<?php echo $i;?>')" checked> <?php _e("Create new field","profilegrid-user-profiles-groups-and-communities");?></li></td>
                <td><input type="radio" name="pm_map_field_<?php echo $i;?>" value="1" onclick="pm_map_field_show_hide(1,'#pm_map_field_with_<?php echo $i;?>')"><?php _e("Map to an existing field","profilegrid-user-profiles-groups-and-communities");?></td>
