...
<!-- </div> -->
<!--  fin du widget perso  -->
 <?php echo do_shortcode(' [oceanwp_library id="645"]') ;?> 
<!-- *****************************code court de ajax pour la recherche des produits et des articles **********************************************************************-->
 <?php echo do_shortcode('[wpdreams_ajaxsearchlite]'); ?>
 <!-- fin du code court**************************************************************************************** -->
<div id="site-header" class="<?php echo esc_attr( oceanwp_header_classes() ); ?>" data-height="<?php echo esc_attr( $header_height ); ?>"<?php oceanwp_schema_markup( 'header' ); ?>>
<?php
