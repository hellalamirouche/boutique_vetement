...
<ul class="<?php echo esc_attr( $wrap_classes ); ?><?php if(is_shop() || is_product_category('accessoires','chemises','cravates','ceintures','chaussures','costume') ){ echo ' '.'liste_produit_boutique'; }elseif(is_front_page()||is_page(array('nouveaute','promotions'))){echo ' '.'liste_produit_accueuil_nouveaute_promo';} ?>" >