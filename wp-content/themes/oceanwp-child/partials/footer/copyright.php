...
// Get copyright text
$copy = get_theme_mod( 'ocean_footer_copyright_text', 'Copyright - Boutica site réalisé par <a href="#" >Amirouche HELLAL </a>' );
...
<div id="footer-bottom" class="<?php echo esc_attr( $wrap_classes ); ?>">
	...
	<div id="footer-bottom-inner" class="container clr">
		...
		if ( has_nav_menu( $menu_location ) ) : ?>
			...
			<div id="footer-bottom-menu" class="navigation clr menu_footer_mentions">
				<?php
				// Display footer menu
				wp_nav_menu( array(
	...
	<div class="text_bas_footer"> © 2019 Boutica </div>
	<?php
